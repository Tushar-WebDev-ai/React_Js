...
function Card({username}) {
  ...
  <div class="text-center">
    <p class="text-base font-semibold text-indigo-400">{username}</p>
    <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">{username}</h1>
